...
// ✅ Specific routes first
router.get("/departments/list", getDepartments);   // List departments
router.get("/", getDoctors);                       // List doctors (optionally by ?department=)
router.get("/:id", getDoctorById);                 // Get doctor by ID

// ✅ RESTful routes
router.post("/", upload.single("photo"), addDoctor);      // Add new doctor
router.put("/:id", upload.single("photo"), updateDoctor); // Update doctor
