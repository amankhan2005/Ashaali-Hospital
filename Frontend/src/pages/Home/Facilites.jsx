  ...
  return (
    <div className="py-8 md:py-10 lg:py-12 bg-gray-100 lg:px-12 px-4 sm:px-6 md:px-8  ">
      <div className="container  mx-auto  ">
        ...
        <div className="lg:text-center text-start mb-4 md:mb-6  mx-auto">
          ...
          <Slider {...settings}>
            {facilities.map((facility) => (
              <div key={facility.id} className="lg:px-3">
                <div className="bg-white rounded-2xl shadow-lg cursor-pointer overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 h-[400px] flex flex-col" onClick={()=>navigate(`/facility/${facility.title.toLowerCase().replace(/\s+/g, '-')}`)}>
                  {/* Image Section */}
