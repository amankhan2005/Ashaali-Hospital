...
//       <div className="relative container  flex  px-8 py-8  bg-gray-100 ">
//         {/* <div className="absolute w h-[500px] bg-gradient-to-b from-teal-500 to-teal-600 rounded-full transform translate-x-[40%] translate-y-[40%] opacity-30"></div> */}

//         <div className="grid md:grid-cols-2   bg-white rounded-lg shadow-lg">
//           {/* Contact Info Section */}
//           <div className=" px-4  flex lg:pt-6 pt-2 md:pt-4">
//             <div>
//               <h1 className=" leading-[3rem] text-xl sm:text-2xl lg:text-2xl text-[#18978d] lg:mb-6 mb-2 md:mb-4">
//                 Get In Touch With Us
//               </h1>
...
//                     <a
//                       href="tel:8303212210"
//                       className="sora-400 text-[1rem] mb-2 text-[#535760] no-underline"
//                     >
//                       +91-83032 12210
//                     </a>
//                   </div>
...
//                 <div className="flex items-start mb-2 mt-2 space-x-4">
//                   <a
//                     href="mailto:ashaalihospital@gmail.com"
//                     className="bg-gradient-to-r from-[#18978d] to-[#ed8022] p-3 rounded-md"
//                   >
...
//                 <div className="flex flex-row justify-around space-x-1 mt-6">
//                   {socialLinks.map((social, index) => (
//                     <a
//                       key={index}
//                       href={social.url}
  ...
  return (
    <section className="min-h-screen">
      ...
      <div className="relative w-full flex items-center justify-center px-4 py-8 md:py-12 lg:py-16 bg-gray-100 overflow-hidden">
        <div className="absolute w-[300px] h-[300px] md:w-[400px] md:h-[400px] lg:w-[500px] lg:h-[500px] bg-gradient-to-b from-teal-500 to-teal-600 rounded-full transform translate-x-[40%] translate-y-[40%] opacity-30"></div>
