...
const OrthopaedicDepartment = () => {
  ...
  const caseStats = [
    {
      ...
      description:
        "Complex joint replacements, fracture repairs, and spine surgeries completed with excellent outcomes",
    },
    {
      count: "15+",
      title: "Years Experience",
      description:
        "Decades of combined expertise in orthopaedic care and surgical excellence",
    },
    {
      count: "24/7",
      title: "Emergency Care",
      description:
        "Round-the-clock availability for urgent orthopaedic emergencies and trauma cases",
    },
    {
      count: "98%",
      title: "Patient Satisfaction",
      description:
        "High success rates and positive patient outcomes across all treatment categories",
    },
  ];
  ...
  const treatments = [
    {
      ...
      description:
        "Anti-inflammatories, analgesics for comprehensive pain control",
    },
    {
    ...
    },
    {
      ...
      description:
        "Regenerative approach using the body's natural healing factors",
    },
    {
      title: "Orthotic Supports & Mobility Aids",
      description:
        "Braces, walkers, and supportive devices for enhanced mobility",
    },
    {
  ...
  const serviceDetails = [
    {
      departmentTitle: "Orthopedic Department",
      subtitle: "Advanced Bone & Joint Care",
      heroDescription:
        "Our orthopedic department provides comprehensive care for all musculoskeletal conditions with state-of-the-art facilities and experienced surgeons dedicated to helping you regain mobility and live pain-free.",
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "With over 15 years of specialized experience in orthopedic care, our team has successfully treated thousands of patients with various bone and joint conditions.",
      successRateTitle: "High Success Rate",
      successRateDesc:
        "Our advanced surgical techniques and comprehensive rehabilitation programs have achieved a 95% patient satisfaction rate with excellent long-term outcomes.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We specialize in treating a wide range of orthopedic conditions from simple fractures to complex joint replacements.",
      proceduresTitle: "Procedures & Surgeries",
      proceduresDesc:
        "Our surgical team performs various advanced procedures using minimally invasive techniques whenever possible.",
      rehabTitle: "Treatment & Rehabilitation",
      rehabDesc:
        "Comprehensive rehabilitation programs designed to restore function and prevent future injuries.",
      symptomsTitle: "Symptoms to Watch Out For",
      symptomsDesc:
        "Early detection and treatment of these symptoms can prevent more serious complications.",
      sideEffectsTitle: "Potential Side Effects",
      sideEffectsDesc:
        "Understanding potential side effects helps in making informed treatment decisions.",
      image: Orthopedics,
      caseStats: [
        {
          count: "5000+",
          title: "Successful Surgeries",
          description:
            "Complex orthopedic surgeries performed with excellent outcomes",
        },
        {
          count: "98%",
          title: "Patient Satisfaction",
          description:
            "Patients report high satisfaction with treatment and care quality",
        },
        {
          count: "15+",
          title: "Years Experience",
          description:
            "Dedicated experience in orthopedic surgery and patient care",
        },
        {
          count: "24/7",
          title: "Emergency Care",
      ...
      procedures: [
        {
          ...
          description:
            "Complete replacement of knee joint for severe arthritis or injury",
        },
        {
          name: "Hip Replacement Surgery",
          description:
            "Advanced hip joint replacement for improved mobility and pain relief",
        },
        {
      ...
      treatments: [
        {
          ...
          description:
            "Customized exercise programs to restore strength and mobility",
        },
        {
          title: "Pain Management",
          description:
            "Comprehensive pain control strategies including medications and injections",
        },
        {
          title: "Occupational Therapy",
          description:
            "Training to help patients return to daily activities and work",
        },
        {
    ...
    {
      departmentTitle: "Ophthalmology Department",
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "With experienced ophthalmologists and retina specialists, we use advanced laser and microsurgical facilities to provide comprehensive eye care for all ages.",
      successRateTitle: "Why Choose Ashaali Hospital for Eye Care?",
      successRateDesc:
        "Advanced Laser & Microsurgical Facilities with Pediatric & Geriatric Eye Care Available, On-site Optical & Diagnostic Lab, Quick Appointments & Minimal Waiting Time, and Transparent Consultation and Post-care Guidance.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We manage both common and serious eye conditions, including:",
      proceduresTitle: "Surgeries & Treatments Offered",
      proceduresDesc:
        "Our eye specialists are skilled in both laser-based and conventional surgical procedures:",
      rehabTitle: "Diagnostic Tools & Procedures",
      rehabDesc:
        "We use modern diagnostic technologies to detect problems early and provide precise care:",
      ...
      sideEffectsDesc:
        "Most treatments are safe, but potential side effects may include:",
      image: ophthalmology,
      caseStats: [
        {
          count: "10,000+",
          title: "Eye Surgeries",
          description:
            "Successful cataract, LASIK and other eye surgeries performed",
        },
        {
          count: "99%",
          title: "Success Rate",
          description:
            "High success rate in vision restoration and eye treatments",
        },
        {
          count: "20+",
          title: "Years Experience",
      ...
      procedures: [
        {
          ...
          description:
            "Advanced cataract removal with intraocular lens implantation",
        },
        {
        ...
        },
        {
          name: "Vitrectomy",
          description:
            "Surgical procedure for retinal disorders and vitreous problems",
        },
        {
      ...
      treatments: [
        {
          ...
          description:
            "Detailed examination of eye structures using magnification",
        },
        {
        ...
        },
        {
          ...
          description:
            "Assessment of peripheral vision and visual field defects",
        },
        {
        ...
        },
        {
          ...
          description:
            "Ultrasound imaging when direct visualization is not possible",
        },
      ],
      symptoms: [
    ...
    },
    {
      ...
      subtitle:
        "Compassionate, Specialized Care for Newborns, Infants & Children",
      heroDescription:
        "At Ashaali Hospital, our Pediatrics & Neonatology Department is dedicated to the health and development of children — from birth through adolescence. We offer comprehensive care for newborns, infants, toddlers, and teens with a focus on prevention, early diagnosis, and personalized treatment.",
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "Our expert pediatricians, neonatologists, and nursing staff create a nurturing, child-friendly environment to make each visit stress-free and safe with years of specialized experience in child healthcare.",
      successRateTitle: "Family-Centered Care",
      successRateDesc:
        "Our parent-inclusive, family-centered care approach ensures comprehensive support for both children and parents throughout the treatment journey with round-the-clock emergency pediatric care.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We manage a wide range of acute and chronic conditions in children from newborn complications to developmental disorders.",
      proceduresTitle: "Services & Facilities",
      proceduresDesc:
        "Our pediatric and neonatal care includes preventive, diagnostic, and intensive support with advanced life-saving equipment.",
      rehabTitle: "Treatment & Support",
      rehabDesc:
        "Comprehensive care programs including nutritional counseling, growth monitoring, and parental support services.",
      symptomsTitle: "Symptoms to Watch in Children",
      symptomsDesc:
        "Parents should consult a pediatrician if their child shows any of these warning signs for early intervention.",
      sideEffectsTitle: "Possible Side Effects",
      sideEffectsDesc:
        "While most pediatric treatments are safe, understanding potential mild and temporary effects helps parents make informed decisions.",
      image: pediatrics,
      caseStats: [
        {
          count: "24/7",
        ...
        },
        {
          ...
          description:
            "Parent-inclusive care approach for comprehensive support",
        },
        {
          count: "NICU/PICU",
          title: "Advanced Units",
          description:
            "Specialized intensive care units for critical newborn and pediatric care",
        },
        {
          count: "Full",
      ...
      procedures: [
        {
          name: "NICU Care",
          description:
            "Neonatal Intensive Care Unit for critical newborn care and life support",
        },
        {
          name: "PICU Care",
          description:
            "Pediatric Intensive Care Unit for emergency and life-threatening conditions",
        },
        {
          name: "Phototherapy",
          description:
            "Specialized light treatment for neonatal jaundice management",
        },
        {
          name: "Newborn Screening",
          description:
            "Comprehensive genetic testing and health screening for newborns",
        },
        {
          name: "Vaccination Programs",
          description:
            "Complete immunization services following IAP schedule guidelines",
        },
      ],
      treatments: [
        {
          ...
          description:
            "Routine checkups and health monitoring for healthy child development",
        },
        {
          title: "Nutritional Counseling",
          description:
            "Growth monitoring and dietary guidance for optimal child nutrition",
        },
        {
        ...
        },
        {
          ...
          description:
            "Child growth and development monitoring with early intervention",
        },
      ],
      symptoms: [
    ...
    },
    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "Our experienced neurologists and neuro-specialists provide comprehensive care from common issues like headaches to complex disorders like epilepsy or stroke with advanced diagnostic capabilities.",
      successRateTitle: "Advanced Neurological Care",
      successRateDesc:
        "Our integrated approach combining advanced diagnostics, specialized treatment protocols, and neuro-rehabilitation services ensures optimal patient outcomes with 24/7 emergency stroke response.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We manage a broad range of neurological disorders affecting the brain, spinal cord, nerves, and muscles with personalized treatment approaches.",
      proceduresTitle: "Diagnostic & Treatment Services",
      proceduresDesc:
        "We use advanced technology and medical expertise to ensure early diagnosis and personalized treatment with state-of-the-art neurological equipment.",
      rehabTitle: "Treatment & Rehabilitation",
      rehabDesc:
        "Comprehensive neuro-rehabilitation services and medication management for chronic neurological conditions with integrated support services.",
      symptomsTitle: "Common Symptoms That Need Neurological Attention",
      symptomsDesc:
        "Please consult a neurologist if you or a loved one experience any of these neurological warning signs for immediate evaluation.",
      sideEffectsTitle: "Possible Side Effects of Neurological Treatment",
      sideEffectsDesc:
        "Most treatments are safe and managed by specialists. Understanding potential side effects helps in comprehensive patient care and management.",
      // image: neurology,
      caseStats: [
        {
          count: "24/7",
          ...
          description:
            "Emergency stroke response team available round-the-clock",
        },
        {
          count: "Advanced",
        ...
        },
        {
          ...
          title: "Neuro-Rehab",
          description:
            "Comprehensive neuro-rehabilitation and recovery services",
        },
      ],
      conditionsTreated: [
      ...
      procedures: [
        {
          ...
          description:
            "Advanced brain wave monitoring for seizure activity and neurological assessment",
        },
        {
          name: "EMG/NCS Testing",
          description:
            "Electromyography and nerve conduction studies for muscle and nerve function evaluation",
        },
        {
          name: "MRI & CT Brain/Spine Scans",
          description:
            "High-resolution imaging for detailed brain and spinal cord assessment",
        },
        {
          name: "Carotid Doppler & Brain Angiography",
          description:
            "Vascular imaging to assess blood flow and detect blockages",
        },
        {
          name: "Botox Therapy",
          description:
            "Specialized treatment for migraine prevention and muscle spasm management",
        },
      ],
      treatments: [
        {
          ...
          description:
            "Comprehensive stroke recovery programs and neuro-rehabilitation services",
        },
        {
          title: "Medication Management",
          description:
            "Personalized medication protocols for chronic neurological conditions",
        },
        {
          title: "Spinal Tap/Lumbar Puncture",
          description:
            "Diagnostic procedures for neurological condition assessment",
        },
        {
          title: "Counseling & Support",
          description:
            "Psychological support and counseling for neurological disorder management",
        },
      ],
      symptoms: [
    ...
    },
    {
      ...
      subtitle:
        "Comprehensive Care for Digestive Health, from Diagnosis to Recovery",
      heroDescription:
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "Our skilled gastroenterologists and liver specialists focus not just on treating symptoms but identifying root causes with advanced endoscopy and diagnostic capabilities for comprehensive digestive care.",
      successRateTitle: "Advanced Digestive Care",
      successRateDesc:
        "Our integrated approach combining medical, surgical, and nutritional support with in-house endoscopy and advanced screening ensures optimal digestive wellness and patient outcomes.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We provide expert care for a wide range of digestive and gastrointestinal conditions from common stomach discomforts to complex liver and pancreatic disorders.",
      proceduresTitle: "Diagnostic & Endoscopy Services",
      proceduresDesc:
        "Our department is equipped with advanced tools for early and accurate diagnosis including state-of-the-art endoscopy and imaging facilities.",
      rehabTitle: "Treatments & Procedures",
      rehabDesc:
        "We offer both medical and minimally invasive treatment options with diet counseling and long-term digestive wellness management programs.",
      symptomsTitle: "Symptoms That Need Gastro Care",
      symptomsDesc:
        "See a gastroenterologist if you have any of these digestive symptoms for comprehensive evaluation and specialized treatment.",
      sideEffectsTitle: "Possible Side Effects of GI Treatments",
      sideEffectsDesc:
        "While treatments are generally safe and well-tolerated, some mild side effects may occur and are carefully monitored by our specialists.",
      image: gasterology,
      caseStats: [
        {
          count: "In-House",
          ...
          description:
            "Advanced endoscopy, colonoscopy and fibroscan facilities",
        },
        {
          count: "Minimal",
          title: "Wait Times",
        ...
        },
        {
          ...
          description:
            "Comprehensive screening for liver, stomach and colon cancers",
        },
        {
          count: "Integrated",
          title: "Support",
      ...
      procedures: [
        {
          ...
          description:
            "Advanced visualization of upper digestive tract for diagnosis and treatment",
        },
        {
          name: "Colonoscopy & Biopsy",
          description:
            "Comprehensive colon examination with tissue sampling for accurate diagnosis",
        },
        {
          name: "ERCP",
          description:
            "Endoscopic Retrograde Cholangiopancreatography for bile duct and pancreatic evaluation",
        },
        {
          name: "Fibroscan",
          description:
            "Non-invasive liver stiffness assessment for liver disease evaluation",
        },
        {
          name: "Abdominal Imaging",
          description:
            "Ultrasound, CT scan, and MRI for comprehensive digestive system evaluation",
        },
      ],
      treatments: [
        {
          ...
          description:
            "Minimally invasive endoscopic polyp removal and bleeding ulcer management",
        },
        {
          title: "Liver Disease Management",
          description:
            "Treatment of liver cirrhosis, portal hypertension, and viral hepatitis",
        },
        {
          title: "Diet Counseling",
          description:
            "Specialized nutritional guidance for digestive health and wellness",
        },
        {
          title: "Therapeutic ERCP",
          description:
            "Advanced stone and blockage removal procedures for bile duct disorders",
        },
      ],
      symptoms: [
    ...
    },
    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "Our highly experienced and specialized surgical team delivers both elective and emergency surgical care with patient-first approach, focusing on advanced techniques and comprehensive post-operative care.",
      successRateTitle: "Surgical Excellence",
      successRateDesc:
        "Our modern operation theatres with advanced equipment and minimally invasive expertise ensure optimal surgical outcomes with quick admission-to-discharge process and comprehensive patient care.",
      conditionsTitle: "Conditions We Treat & Surgeries Offered",
      conditionsDesc:
        "We provide comprehensive surgical care for a wide range of conditions from routine procedures to complex surgeries using latest minimally invasive techniques.",
      proceduresTitle: "Surgical Facilities & Technologies",
      proceduresDesc:
        "Our operation theatres and surgical protocols follow the highest standards of safety and precision with state-of-the-art equipment and sterile protocols.",
      rehabTitle: "Treatment & Recovery",
      rehabDesc:
        "Advanced surgical techniques with comprehensive post-operative rehabilitation and recovery programs including day-care surgery options for faster discharge.",
      symptomsTitle: "Symptoms That May Require Surgical Evaluation",
      symptomsDesc:
        "You should consult a general surgeon if you notice any of these symptoms that may indicate need for surgical intervention.",
      sideEffectsTitle: "Possible Side Effects & Surgical Risks",
      sideEffectsDesc:
        "Our surgeries are performed with the highest safety standards, but as with any medical procedure, potential side effects are carefully monitored and managed.",
      image: general,
      caseStats: [
        {
          count: "Advanced",
          ...
          description:
            "Modern operation theatres with HEPA filters and sterile protocols",
        },
        {
          count: "Minimally Invasive",
          title: "Techniques",
          description:
            "Laparoscopic and endoscopic expertise for faster recovery",
        },
        {
          count: "Day-Care",
          title: "Surgery Options",
          description:
            "Quick admission-to-discharge process with same-day procedures",
        },
        {
          count: "24/7",
          title: "Emergency Care",
      ...
      procedures: [
        {
          ...
          description:
            "Minimally invasive surgical techniques for faster recovery and minimal scarring",
        },
        {
          name: "Modular Operation Theatre",
          description:
            "State-of-the-art OT with HEPA filters and advanced sterile protocols",
        },
        {
          name: "Ultrasound & CT-Guided Procedures",
          description:
            "Image-guided biopsies and surgical interventions for precision",
        },
        {
          name: "Emergency Surgical Care",
          description:
            "24/7 trauma and emergency surgical services with ICU backup",
        },
        {
          name: "Endoscopic Procedures",
          description:
            "Advanced endoscopic equipment for diagnostic and therapeutic interventions",
        },
      ],
      treatments: [
        {
          ...
          description:
            "Comprehensive pre-operative assessment and anesthesia planning for safe surgery",
        },
        {
          title: "Post-Operative Care",
          description:
            "Dedicated recovery rooms with specialized monitoring and nursing care",
        },
        {
          title: "Pain Management",
          description:
            "Advanced pain control protocols for comfortable post-surgical recovery",
        },
        {
          title: "Wound Care & Follow-up",
          description:
            "Comprehensive wound management and post-operative follow-up care",
        },
      ],
      symptoms: [
    ...
    },
    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "Our experienced team of female gynecologists and obstetricians provides comprehensive women's health care with a focus on personalized, respectful, and confidential treatment in a comfortable, safe, and modern environment.",
      successRateTitle: "High Success Rate",
      successRateDesc:
        "Our advanced medical facilities and women-centric approach ensure excellent outcomes for both routine and high-risk pregnancies, with comprehensive support from first period to motherhood and beyond.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We diagnose and treat a full spectrum of women's health issues across all stages of life.",
      proceduresTitle: "Services & Procedures Offered",
      proceduresDesc:
        "We provide both outpatient and surgical care, including obstetric and gynecological services.",
      rehabTitle: "Recovery & Postnatal Care",
      rehabDesc:
        "Comprehensive postnatal care and recovery support designed to ensure optimal health for mother and baby.",
      symptomsTitle: "Symptoms That Require Consultation",
      symptomsDesc:
        "These symptoms indicate you should see a gynecologist for proper evaluation and treatment.",
      sideEffectsTitle: "Possible Side Effects or Recovery Notes",
      sideEffectsDesc:
        "Most procedures are safe, but minor issues may occur during recovery.",
      image: obsetric,
      caseStats: [
        {
          count: "24/7",
          title: "Emergency Care",
          description:
            "Round-the-clock obstetric and gynecological emergency care available",
        },
        {
          count: "100%",
          title: "Women-Centric Care",
          description:
            "Confidential, respectful, and personalized approach to women's health",
        },
        {
          count: "Advanced",
          title: "Medical Facilities",
          description:
            "Fully equipped labor room, operation theaters, and NICU support",
        },
        {
          count: "Expert",
          title: "Medical Team",
      ...
      procedures: [
        {
          ...
          description:
            "Comprehensive obstetric care for safe and comfortable childbirth experience",
        },
        {
          name: "C-Section (Cesarean Delivery)",
          description:
            "Advanced surgical delivery when medically necessary for mother and baby safety",
        },
        {
          name: "Laparoscopy & Hysteroscopy",
          description:
            "Minimally invasive procedures for diagnosis and treatment of gynecological conditions",
        },
        {
          name: "Hysterectomy",
          description:
            "Uterus removal surgery using open or laparoscopic techniques as required",
        },
        {
          name: "Ovarian Cystectomy & Fibroid Removal",
          description:
            "Surgical removal of ovarian cysts and uterine fibroids for improved health",
        },
      ],
      treatments: [
        {
          ...
          description:
            "Comprehensive pregnancy checkups, scans, and monitoring for healthy pregnancy",
        },
        {
          title: "Postnatal Care",
          description:
            "Complete care for mother and baby including breastfeeding guidance and recovery support",
        },
        {
          title: "Infertility Treatment",
          description:
            "Specialized care and counseling for couples facing conception difficulties",
        },
        {
          title: "Menopause Management",
          description:
            "Comprehensive care for managing menopausal symptoms and hormonal changes",
        },
      ],
      symptoms: [
    ...
    },
    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "Our experienced urologists and laser specialists provide comprehensive care using modern diagnostic tools and therapeutic procedures, with emphasis on precision and faster recovery through minimally invasive techniques.",
      successRateTitle: "High Success Rate",
      successRateDesc:
        "Our advanced endoscopic and laser-assisted procedures, combined with sterile OT protocols and comprehensive post-operative support, ensure excellent treatment outcomes and patient satisfaction.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We manage a wide range of urological conditions affecting the urinary tract and male reproductive system.",
      proceduresTitle: "Surgeries & Minimally Invasive Procedures",
      proceduresDesc:
        "We offer a full range of urologic surgeries with emphasis on precision, safety, and faster recovery.",
      rehabTitle: "Diagnostic & Treatment Services",
      rehabDesc:
        "Our department is equipped with modern diagnostic tools and comprehensive therapeutic procedures for optimal patient care.",
      symptomsTitle: "Symptoms That Need Urological Evaluation",
      symptomsDesc:
        "These symptoms indicate you should consult a urologist for proper evaluation and treatment.",
      sideEffectsTitle: "Possible Side Effects or Post-treatment Observations",
      sideEffectsDesc:
        "While treatments are generally safe, you may experience minor temporary effects during recovery.",
      image: urology,
      caseStats: [
        {
          count: "24/7",
          title: "Emergency Care",
          description:
            "Round-the-clock urological emergency care and support available",
        },
        {
          count: "Advanced",
          title: "Laser Technology",
          description:
            "State-of-the-art laser lithotripsy and minimally invasive procedures",
        },
        {
          count: "Expert",
          title: "Urologists",
          description:
            "Experienced urologists and laser specialists providing comprehensive care",
        },
        {
          count: "100%",
          title: "Patient Privacy",
          description:
            "Discreet, private, and patient-friendly consultations maintained",
        },
      ],
      conditionsTreated: [
      ...
      procedures: [
        {
          ...
          description:
            "Minimally invasive procedure for removing ureteric stones using advanced endoscopic techniques",
        },
        {
          name: "PCNL (Percutaneous Nephrolithotomy)",
          description:
            "Advanced surgical procedure for removing large kidney stones through small incisions",
        },
        {
          name: "TURP (Transurethral Resection of Prostate)",
          description:
            "Surgical treatment for prostate enlargement to improve urinary flow and symptoms",
        },
        {
          name: "Laser Lithotripsy",
          description:
            "Stone breaking procedure using laser technology without making external cuts",
        },
        {
          name: "Laparoscopic Nephrectomy",
          description:
            "Minimally invasive kidney surgery using laparoscopic techniques for faster recovery",
        },
      ],
      treatments: [
        {
          ...
          description:
            "Comprehensive diagnostic tools including ultrasound KUB, uroflowmetry, PSA tests, and urodynamic studies",
        },
        {
          title: "Stone Management",
          description:
            "Complete stone analysis, metabolic evaluation, and various treatment options from medication to surgery",
        },
        {
          title: "Male Health Services",
          description:
            "Specialized care for male sexual health, infertility, and reproductive system disorders",
        },
        {
          title: "Post-operative Care",
          description:
            "Comprehensive post-surgical support and monitoring for optimal recovery and outcomes",
        },
      ],
      symptoms: [
    ...
    {
      departmentTitle: "ENT Department",
      subtitle: "Complete Care for Hearing, Breathing, and Voice Health",
      heroDescription:
        "Ashaali Hospital’s ENT Department offers specialized care for disorders related to the ear, nose, throat, head, and neck. Our ENT specialists provide medical and surgical treatments using the latest technology to help patients breathe better, hear clearly, speak confidently, and live comfortably.",
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "We deliver patient-focused ENT care for everything from minor infections to complex surgeries, using advanced diagnostic tools and expert clinical judgment.",
      successRateTitle: "High Success Rate",
      successRateDesc:
        "With experienced surgeons and modern technology, our ENT procedures boast a high success rate and quick recovery for most patients.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We diagnose and manage a wide range of ENT-related conditions affecting the ear, nose, throat, and neck regions.",
      proceduresTitle: "Surgeries & Procedures Offered",
      proceduresDesc:
        "We offer both conservative and advanced surgical management for ENT conditions using minimally invasive techniques.",
      rehabTitle: "Diagnostic & Treatment Services",
      rehabDesc:
        "Equipped with modern ENT diagnostic tools to enable early and accurate diagnosis and tailored treatment plans.",
      symptomsTitle: "Symptoms to Watch Out For",
      symptomsDesc:
        "Consult an ENT specialist if you experience any of these persistent or recurring symptoms.",
      sideEffectsTitle: "Possible Side Effects",
      sideEffectsDesc:
        "Most ENT procedures are safe. However, being aware of minor risks can help in informed decision-making.",
      image: Dental,
      caseStats: [
        {
          count: "3500+",
          ...
          description:
            "Successful ENT procedures including nasal, throat, and ear surgeries",
        },
        {
          count: "96%",
          title: "Patient Satisfaction",
          description:
            "Patients appreciate precise diagnosis and effective treatment outcomes",
        },
        {
          count: "10+",
          title: "Years Expertise",
          description:
            "ENT specialists with over a decade of experience in treating complex cases",
        },
        {
          count: "24/7",
          title: "Emergency ENT Care",
          description:
            "Immediate treatment for trauma, foreign bodies, and airway blockages",
        },
      ],
      conditionsTreated: [
      ...
      procedures: [
        ...
        },
        {
          ...
          description:
            "Removal of tonsils or adenoids for recurrent infections",
        },
        {
      ...
      treatments: [
        ...
        },
        {
          ...
          description:
            "Advanced nasal and throat evaluation for accurate treatment",
        },
        {
...

    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "With years of experience managing complex hormonal disorders, our endocrinology team delivers compassionate, research-driven care tailored to each patient’s unique needs.",
      successRateTitle: "High Success Rate",
      successRateDesc:
        "Our evidence-based treatments and continuous monitoring ensure long-term management and better outcomes for chronic endocrine conditions like diabetes and thyroid dysfunction.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We manage a wide range of endocrine disorders involving hormones, glands, and metabolism, using holistic and personalized approaches.",
      proceduresTitle: "Diagnostic Procedures",
      proceduresDesc:
        "We perform advanced diagnostic tests to detect and monitor hormone levels and glandular function accurately.",
      rehabTitle: "Treatment & Management",
      rehabDesc:
        "Focused on lifestyle modification, medication management, and patient education for long-term wellness.",
      symptomsTitle: "Symptoms to Watch Out For",
      symptomsDesc:
        "Recognizing early signs of hormonal imbalance can help prevent long-term complications.",
      sideEffectsTitle: "Potential Side Effects",
      sideEffectsDesc:
        "Endocrine treatments are generally safe, though some medications may cause mild or temporary side effects.",
      image: Enderinology,
      caseStats: [
        {
          count: "6000+",
          ...
          description:
            "Long-term care for diabetes, thyroid, and hormonal disorders",
        },
        {
          count: "97%",
          title: "Improved Quality of Life",
          description:
            "Patients report better health outcomes and daily well-being",
        },
        {
          count: "12+",
          title: "Years of Expertise",
          description:
            "Specialists with in-depth experience in hormonal therapy",
        },
        {
          count: "24/7",
          title: "Emergency Diabetic Care",
          description:
            "Round-the-clock support for critical sugar fluctuations",
        },
      ],
      conditionsTreated: [
      ...
      procedures: [
        {
          name: "HbA1c Testing",
          description:
            "Measures long-term blood sugar control in diabetic patients",
        },
        {
      ...
      treatments: [
        ...
        },
        {
          ...
          description:
            "Support for weight loss, healthy eating, and fitness goals",
        },
      ],
      symptoms: [
...

    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "Our team has years of experience treating chronic rheumatic conditions like arthritis, lupus, and vasculitis with a patient-centric and compassionate approach.",
      successRateTitle: "High Success Rate",
      successRateDesc:
        "Through early diagnosis, multidisciplinary management, and advanced therapies, we help patients manage symptoms effectively and improve quality of life.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We manage a wide range of autoimmune and musculoskeletal disorders that cause pain, inflammation, and disability.",
      proceduresTitle: "Diagnostic Procedures",
      proceduresDesc:
        "We use clinical evaluation, blood markers, imaging, and joint fluid analysis for accurate diagnosis.",
      rehabTitle: "Treatment & Rehabilitation",
      rehabDesc:
        "Our approach includes medication, physical therapy, and long-term monitoring to manage inflammation and prevent joint damage.",
      symptomsTitle: "Symptoms to Watch Out For",
      symptomsDesc:
        "Persistent joint or muscle symptoms may signal an underlying rheumatic condition and should not be ignored.",
      sideEffectsTitle: "Potential Side Effects",
      sideEffectsDesc:
        "Some rheumatology treatments may have side effects; monitoring helps minimize risks and ensures safety.",
      ...
      caseStats: [
        {
          ...
          description:
            "Successful long-term care for autoimmune and inflammatory diseases",
        },
        {
          count: "95%",
          title: "Improved Mobility",
          description:
            "Patients report reduced joint pain and improved physical activity levels",
        },
        {
          count: "10+",
          title: "Years Expertise",
          description:
            "Expert rheumatologists experienced in complex autoimmune disorders",
        },
        {
          count: "24/7",
          title: "Flare-Up Care",
          description:
            "Support during sudden symptom flare-ups and emergencies",
        },
      ],
      conditionsTreated: [
      ...
      procedures: [
        {
          ...
          description:
            "Relieves inflammation and pain by removing joint fluid or injecting medication",
        },
        {
          name: "Autoantibody Testing",
          description:
            "Detects autoimmune markers like ANA, RF, anti-CCP for accurate diagnosis",
        },
        {
        ...
        },
        {
          ...
          description:
            "Non-invasive imaging for detecting joint damage and synovitis",
        },
        {
          name: "Bone Density Test (DEXA)",
          description:
            "Assesses bone loss, especially in patients on long-term steroids",
        },
      ],
      treatments: [
        {
          ...
          description:
            "Slows down disease progression in autoimmune conditions",
        },
        {
          title: "Biologic Therapy",
          description:
            "Targeted treatments for moderate-to-severe autoimmune arthritis",
        },
        {
          title: "Pain & Inflammation Management",
          description:
            "NSAIDs, corticosteroids, and other medications for symptom relief",
        },
        {
          title: "Physiotherapy & Joint Rehab",
          description:
            "Exercises to maintain joint mobility, reduce stiffness, and strengthen muscles",
        },
      ],
      symptoms: [
        {
...

    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "With vast experience in treating solid and blood-related cancers, our expert team combines clinical excellence with emotional support to deliver the best outcomes for patients and families.",
      successRateTitle: "Survivorship & Quality of Life",
      successRateDesc:
        "Our cancer management strategies aim not just at survival but also at maintaining dignity, strength, and quality of life during and after treatment.",
      conditionsTitle: "Types of Cancers We Treat",
      conditionsDesc:
        "We treat a broad spectrum of cancers using tailored approaches based on stage, type, and individual patient needs.",
      proceduresTitle: "Treatment Procedures & Therapies",
      proceduresDesc:
        "We use a combination of chemotherapy, radiotherapy, immunotherapy, and surgical interventions for best outcomes.",
      rehabTitle: "Supportive Care & Rehabilitation",
      rehabDesc:
        "Nutritional, psychological, pain, and palliative support services are integrated into our cancer care model.",
      symptomsTitle: "Symptoms to Watch Out For",
      symptomsDesc:
        "Early detection is critical in cancer care. Be aware of common warning signs that should prompt medical attention.",
      sideEffectsTitle: "Potential Side Effects",
      sideEffectsDesc:
        "Cancer treatments may have temporary or long-term side effects that are closely monitored and managed.",
      ...
      caseStats: [
        {
          ...
          description:
            "Expert multidisciplinary care across all major types of cancers",
        },
        {
          count: "93%",
          title: "Improved Quality of Life",
          description:
            "Patients report reduced pain, extended remission, and emotional support",
        },
        {
          count: "8+",
          title: "Years of Oncology Expertise",
          description:
            "Specialists trained in latest cancer care techniques and innovations",
        },
        {
          count: "24/7",
          title: "Onco Emergency Support",
          description:
            "Emergency care for cancer-related complications and pain management",
        },
      ],
      conditionsTreated: [
        "Breast Cancer",
      ...
      procedures: [
        {
          name: "Chemotherapy",
          description:
            "Use of cancer-killing drugs administered intravenously or orally",
        },
        {
          name: "Radiation Therapy",
          description:
            "High-energy beams to destroy or shrink cancerous tissues",
        },
        {
          name: "Surgical Oncology",
          description:
            "Removal of tumors and affected tissues by specialized cancer surgeons",
        },
        {
          name: "Immunotherapy",
        ...
        },
        {
          ...
          description:
            "Medications that target specific cancer cell genes or proteins",
        },
      ],
      treatments: [
        {
          title: "Pain Management",
          description:
            "Dedicated team for controlling chronic cancer-related pain",
        },
        {
          title: "Palliative Care",
          description:
            "Improves comfort and support for patients with advanced cancer",
        },
        {
...

    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "With years of experience managing cardiovascular diseases, our team has successfully treated thousands of patients through evidence-based medical and interventional cardiology.",
      successRateTitle: "Trusted Heart Care",
      successRateDesc:
        "Our cardiology team ensures a high rate of successful interventions and long-term health outcomes, with a strong focus on prevention and patient education.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We diagnose and manage a wide range of cardiovascular conditions, from hypertension to heart failure and congenital heart diseases.",
      proceduresTitle: "Cardiac Tests & Procedures",
      proceduresDesc:
        "We use advanced diagnostic tools and minimally invasive procedures to assess and restore heart function effectively.",
      rehabTitle: "Cardiac Rehab & Lifestyle Care",
      rehabDesc:
        "Post-treatment rehabilitation and preventive guidance to ensure long-term heart health and reduce the risk of recurrence.",
      symptomsTitle: "Symptoms to Watch Out For",
      symptomsDesc:
        "Don’t ignore signs of heart distress — early diagnosis saves lives.",
      sideEffectsTitle: "Potential Side Effects",
      sideEffectsDesc:
        "Cardiac treatments are safe, but like all procedures, some temporary side effects may occur and are monitored closely.",
      ...
      caseStats: [
        {
          ...
          description:
            "Including emergency heart care, angioplasty, and chronic condition management",
        },
        {
          count: "96%",
          title: "Positive Recovery Rate",
          description:
            "Improved lifestyle and reduced cardiac complications post-treatment",
        },
        {
          count: "12+",
          title: "Years of Expertise",
          description:
            "Our cardiologists bring extensive experience in interventional and non-invasive cardiology",
        },
        {
          count: "24/7",
          title: "Emergency Cardiac Support",
          description:
            "Critical heart care including heart attack response available around the clock",
        },
      ],
      conditionsTreated: [
      ...
      procedures: [
        ...
        },
        {
          ...
          description:
            "Ultrasound imaging to assess heart chambers, valves, and function",
        },
        {
        ...
        },
        {
          ...
          description:
            "Imaging and balloon/stent procedure to open blocked arteries",
        },
        {
          name: "Pacemaker Implantation",
          description:
            "Device placement to regulate heartbeat in rhythm disorders",
        },
      ],
      treatments: [
        {
          title: "Medication Management",
          description:
            "Customized prescriptions for blood pressure, cholesterol, heart rhythm, and more",
        },
        {
        ...
        },
        {
          ...
          description:
            "Lifestyle, diet, and stress management plans to reduce future cardiac risks",
        },
        {
          title: "Cardiac Rehabilitation",
          description:
            "Supervised program of exercise and education for recovery after cardiac events",
        },
      ],
      symptoms: [
...

    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "With a decade of experience treating diverse mental health conditions, our team focuses on empathetic care, accurate diagnosis, and long-term emotional wellness.",
      successRateTitle: "Restoring Mental Well-Being",
      successRateDesc:
        "Our holistic approach to psychiatry ensures high recovery and satisfaction rates, helping individuals return to productive and fulfilling lives.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We address a broad spectrum of mental health conditions across all age groups using therapeutic and medical management.",
      proceduresTitle: "Diagnostic & Therapy Services",
      proceduresDesc:
        "Comprehensive assessments, psychiatric evaluations, and evidence-based therapy interventions for accurate treatment planning.",
      rehabTitle: "Therapy & Rehabilitation",
      rehabDesc:
        "Ongoing counseling, medication support, lifestyle guidance, and family involvement to ensure stable recovery.",
      symptomsTitle: "Symptoms to Watch Out For",
      symptomsDesc:
        "Seek help if you or your loved ones notice changes in thinking, behavior, or emotional state that interfere with daily life.",
      sideEffectsTitle: "Potential Side Effects",
      sideEffectsDesc:
        "Psychiatric medications and therapies may have some side effects, which are monitored and managed carefully.",
      ...
      caseStats: [
        {
          ...
          description:
            "Successful treatment of anxiety, depression, schizophrenia, and more",
        },
        {
          count: "94%",
          title: "Stabilization & Recovery Rate",
          description:
            "Most patients show significant improvement with therapy and medication",
        },
        {
          count: "10+",
          title: "Years of Psychiatric Excellence",
          description:
            "Our psychiatrists and therapists are trained in both modern and holistic approaches",
        },
        {
          count: "24/7",
          title: "Crisis & Emergency Support",
          description:
            "Immediate intervention for mental health emergencies including suicide prevention",
        },
      ],
      conditionsTreated: [
      ...
      procedures: [
        ...
        },
        {
          ...
          description:
            "Structured psychotherapy for depression, anxiety, and other issues",
        },
        {
          name: "Medication Management",
          description:
            "Prescribing and monitoring antidepressants, antipsychotics, anxiolytics",
        },
        {
          name: "Family & Group Therapy",
          description:
            "Involving families in care plans and peer group recovery",
        },
        {
          name: "Psychological Testing",
          description:
            "Standardized tests for memory, IQ, attention, personality traits, etc.",
        },
      ],
      treatments: [
        {
        ...
        },
        {
          ...
          description:
            "Safe and regular pharmacological management for symptom control",
        },
        {
          title: "Rehabilitation & Aftercare",
          description:
            "Support for reintegration, long-term stability, and relapse prevention",
        },
      ],
      symptoms: [
...

    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "With a team of expert dermatologists and cosmetologists, we have successfully treated thousands of patients for chronic skin conditions, infections, allergies, and aesthetic concerns.",
      successRateTitle: "Healthy Skin, Happy Patients",
      successRateDesc:
        "With accurate diagnosis and tailored treatment plans, our dermatology care ensures high patient satisfaction and long-term results.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We offer treatment for a wide range of dermatological conditions, including chronic, infectious, allergic, and cosmetic skin issues.",
      proceduresTitle: "Diagnostic & Cosmetic Procedures",
      proceduresDesc:
        "From skin biopsies to cosmetic lasers, we offer safe and effective procedures tailored to each patient’s needs.",
      rehabTitle: "Skin Care & Maintenance",
      rehabDesc:
        "Post-treatment care, preventive skincare guidance, and routine follow-ups to ensure lasting results.",
      symptomsTitle: "Symptoms to Watch Out For",
      symptomsDesc:
        "Timely consultation can prevent minor skin issues from turning into chronic or severe problems.",
      sideEffectsTitle: "Potential Side Effects",
      sideEffectsDesc:
        "Dermatological treatments are generally safe but may cause mild, temporary side effects depending on the procedure.",
      ...
      caseStats: [
        {
          ...
          description:
            "From acne to eczema to cosmetic issues with successful outcomes",
        },
        {
          count: "98%",
          title: "Patient Satisfaction Rate",
          description:
            "Patients report visible improvement and increased confidence",
        },
        {
          count: "10+",
          title: "Years of Expertise",
          description:
            "Experienced dermatologists trained in both clinical and cosmetic dermatology",
        },
        {
          count: "24/7",
          title: "Emergency Skin Care",
          description:
            "Support for allergic reactions, burns, and acute infections",
        },
      ],
      conditionsTreated: [
        "Acne & Acne Scars",
      ...
      procedures: [
        {
          name: "Skin Biopsy",
          description:
            "Microscopic analysis of skin tissue to diagnose various conditions",
        },
        {
          name: "Chemical Peels",
          description:
            "Removes damaged outer skin to treat acne, scars, and pigmentation",
        },
        {
          name: "Laser Skin Treatments",
          description:
            "Advanced laser technology for hair removal, scars, and skin rejuvenation",
        },
        {
          name: "Cryotherapy",
      ...
      treatments: [
        {
          ...
          description:
            "Topical and oral medications for bacterial, fungal, and inflammatory skin conditions",
        },
        {
          title: "Cosmetic Dermatology",
          description:
            "Anti-aging treatments, pigmentation correction, and skin polishing",
        },
        {
        ...
        },
        {
          ...
          description:
            "Identify and manage contact dermatitis and chronic skin allergies",
        },
      ],
      symptoms: [
...

    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "Our pulmonology team brings years of experience treating thousands of patients with respiratory illnesses through a combination of medical management, diagnostics, and rehabilitation.",
      successRateTitle: "Breathe Easy with Us",
      successRateDesc:
        "With a strong track record in managing chronic respiratory conditions, our patients enjoy improved lung function, reduced hospitalizations, and a better quality of life.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We manage a wide range of pulmonary conditions affecting the lungs, bronchi, pleura, and respiratory muscles.",
      proceduresTitle: "Diagnostic & Interventional Services",
      proceduresDesc:
        "Accurate diagnosis using advanced imaging, endoscopy, and lab tests for optimal treatment planning.",
      rehabTitle: "Pulmonary Rehab & Care",
      rehabDesc:
        "Our comprehensive programs include medication, oxygen therapy, and physical training to improve lung strength and endurance.",
      symptomsTitle: "Symptoms to Watch Out For",
      symptomsDesc:
        "Do not ignore breathing issues — early intervention can prevent long-term complications.",
      sideEffectsTitle: "Potential Side Effects",
      sideEffectsDesc:
        "Respiratory treatments are safe, but some may cause temporary side effects which are monitored closely.",
      ...
      caseStats: [
        ...
        },
        {
          ...
          description:
            "Majority of patients report better oxygen levels and symptom relief",
        },
        {
          count: "10+",
          title: "Years of Expertise",
          description:
            "Team experienced in both acute and chronic respiratory care",
        },
        {
          count: "24/7",
          title: "Emergency Respiratory Support",
          description:
            "Ventilator support and critical care for breathing emergencies",
        },
      ],
      conditionsTreated: [
        "Asthma",
      ...
      procedures: [
        {
          ...
          description:
            "Measures lung capacity, airflow, and respiratory strength",
        },
        {
          name: "Bronchoscopy",
          description:
            "Endoscopic procedure to view airways and collect samples",
        },
        {
          name: "Chest X-Ray & CT Scan",
          description:
            "Imaging to diagnose infections, tumors, or structural abnormalities",
        },
        {
          name: "Sleep Study (Polysomnography)",
          description:
            "Evaluates sleep apnea and other nighttime breathing disorders",
        },
        {
      ...
      treatments: [
        {
          ...
          description:
            "Delivers medication directly to the lungs for rapid relief",
        },
        {
        ...
        },
        {
          ...
          description:
            "Supports patients with low oxygen levels or chronic hypoxia",
        },
        {
          title: "Pulmonary Rehabilitation",
          description:
            "Exercise and education to improve lung capacity and reduce breathlessness",
        },
      ],
      symptoms: [
...

    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "With years of experience treating complex hematological disorders, we combine clinical expertise with cutting-edge diagnostics and personalized care plans.",
      successRateTitle: "Effective Blood Disorder Management",
      successRateDesc:
        "Through early diagnosis, targeted therapies, and continuous monitoring, we ensure high treatment success and improved quality of life.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We manage a wide range of hematologic disorders, from anemia and bleeding issues to blood cancers like leukemia and lymphoma.",
      proceduresTitle: "Diagnostic & Therapeutic Services",
      proceduresDesc:
        "Advanced laboratory tests, bone marrow analysis, transfusions, and chemotherapy for precise treatment planning and delivery.",
      rehabTitle: "Post-Treatment Monitoring & Support",
      rehabDesc:
        "Ongoing monitoring, nutritional care, and infection control are vital parts of our hematology treatment model.",
      symptomsTitle: "Symptoms to Watch Out For",
      symptomsDesc:
        "Timely recognition of blood-related symptoms helps in early diagnosis and successful treatment.",
      sideEffectsTitle: "Potential Side Effects",
      sideEffectsDesc:
        "Hematological treatments may involve temporary or long-term side effects, which we manage carefully at each step.",
      ...
      caseStats: [
        {
          ...
          description:
            "Including anemia, clotting disorders, and hematologic cancers",
        },
        {
          count: "90%",
          title: "Remission & Recovery Rate",
          description:
            "Patients with early intervention show excellent treatment outcomes",
        },
        {
          count: "8+",
          title: "Years of Hematology Expertise",
          description:
            "Specialized team trained in rare and chronic blood diseases",
        },
        {
          count: "24/7",
          title: "Emergency Bleeding Care",
          description:
            "Immediate attention for bleeding crises and transfusion needs",
        },
      ],
      conditionsTreated: [
      ...
      procedures: [
        {
          ...
          description:
            "Initial test to evaluate red cells, white cells, and platelets",
        },
        {
          name: "Bone Marrow Biopsy",
          description:
            "Helps diagnose leukemia, lymphoma, anemia, and marrow failure",
        },
        {
          name: "Coagulation Profile (PT, INR, aPTT)",
          description:
            "Assesses clotting ability in bleeding or bruising disorders",
        },
        {
        ...
        },
        {
          ...
          description:
            "Used in severe anemia, bleeding, or chemotherapy support",
        },
      ],
      treatments: [
        {
          ...
          description:
            "For treating iron-deficiency anemia and chronic fatigue",
        },
        {
          title: "Chemotherapy for Blood Cancers",
          description:
            "Targeted drug therapy for leukemia, lymphoma, and myeloma",
        },
        {
          title: "Clotting Factor Replacement",
          description:
            "Essential treatment for hemophilia and inherited bleeding disorders",
        },
        {
          title: "Bone Marrow Transplant Referral & Coordination",
          description:
            "Support for transplant candidates including donor matching",
        },
      ],
      symptoms: [
...

    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "With a skilled team and modern facilities, we have treated thousands of patients for dental problems, offering expert care for everything from routine cleanings to surgical procedures.",
      successRateTitle: "Smile with Confidence",
      successRateDesc:
        "Our focus on precision, hygiene, and aesthetics results in high patient satisfaction and long-lasting oral health outcomes.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We diagnose and manage all common and complex dental and oral health conditions in children and adults.",
      proceduresTitle: "Dental Treatments & Procedures",
      proceduresDesc:
        "From tooth fillings to smile makeovers, we offer a wide range of dental services under one roof.",
      rehabTitle: "Oral Care & Post-Treatment Support",
      rehabDesc:
        "We provide guidance for oral hygiene maintenance, diet, and regular check-ups after treatments.",
      symptomsTitle: "Symptoms to Watch Out For",
      symptomsDesc:
        "Don't ignore oral symptoms — early treatment prevents complications and ensures better outcomes.",
      sideEffectsTitle: "Potential Side Effects",
      sideEffectsDesc:
        "Dental procedures are generally safe, though some may have mild, short-term side effects.",
      ...
      caseStats: [
        {
          ...
          description:
            "From cleanings and fillings to surgeries and cosmetic corrections",
        },
        {
          count: "97%",
          title: "Patient Satisfaction",
          description:
            "Patients report pain-free experience and long-term dental health improvements",
        },
        {
          count: "12+",
          title: "Years of Dental Excellence",
          description:
            "Trusted experience across general dentistry, prosthodontics, and orthodontics",
        },
        {
          count: "6 Days",
          title: "Weekly Availability",
          description:
            "Convenient scheduling with extended hours for working patients",
        },
      ],
      conditionsTreated: [
      ...
      procedures: [
        {
          ...
          description:
            "Removes plaque and tartar to prevent gum disease and decay",
        },
        {
          name: "Tooth Filling & Restoration",
          description:
            "Restores decayed or broken teeth using durable filling materials",
        },
        {
          name: "Root Canal Treatment (RCT)",
          description:
            "Treats infected tooth pulp and preserves the natural tooth",
        },
        {
        ...
        },
        {
          ...
          description:
            "Orthodontic solutions to correct teeth alignment and improve bite",
        },
      ],
      treatments: [
        {
          ...
          description:
            "Gentle dental services for children including fluoride treatment and sealants",
        },
        {
          title: "Dental Implants & Crowns",
          description:
            "Permanent replacements for missing teeth with natural appearance",
        },
        {
          title: "Smile Design & Whitening",
          description:
            "Cosmetic treatments for a brighter, more confident smile",
        },
        {
          title: "Gum Treatment & Surgery",
          description:
            "Treats gingival diseases, recession, and overgrowth with precision",
        },
      ],
      symptoms: [
...

    {
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "With extensive expertise in nephrology, our team has treated thousands of patients with both acute and chronic kidney issues, including those requiring dialysis and long-term care.",
      successRateTitle: "Committed to Renal Wellness",
      successRateDesc:
        "Our focus on early detection, lifestyle management, and patient education ensures a high success rate in slowing kidney disease progression and improving quality of life.",
      conditionsTitle: "Conditions We Treat",
      conditionsDesc:
        "We manage a wide range of kidney and urinary disorders including infections, chronic kidney disease, and renal failure.",
      proceduresTitle: "Diagnostic & Therapeutic Services",
      proceduresDesc:
        "From kidney function tests to dialysis and biopsies, we offer complete nephrology care under one roof.",
      rehabTitle: "Ongoing Monitoring & Renal Rehab",
      rehabDesc:
        "Our comprehensive follow-up care includes dietary plans, medication management, and dialysis support.",
      symptomsTitle: "Symptoms to Watch Out For",
      symptomsDesc:
        "Recognizing early signs of kidney problems can help prevent progression to renal failure.",
      sideEffectsTitle: "Potential Side Effects",
      sideEffectsDesc:
        "Kidney treatments, especially dialysis and medications, may have side effects, which we monitor and manage closely.",
      ...
      caseStats: [
        {
          ...
          description:
            "Successful treatment of both acute and chronic kidney conditions",
        },
        {
          count: "92%",
          title: "Stabilization Rate in CKD",
          description:
            "High rate of slowing disease progression with consistent care",
        },
        {
          count: "10+",
          title: "Years of Nephrology Expertise",
          description:
            "Managing patients across various stages of kidney disorders",
        },
        {
          count: "24/7",
          title: "Dialysis & Emergency Support",
          description:
            "Critical care for renal failure and 24x7 dialysis services",
        },
      ],
      conditionsTreated: [
      ...
      procedures: [
        {
          ...
          description:
            "Assess levels of creatinine, urea, and electrolytes to monitor kidney performance",
        },
        {
          name: "Hemodialysis",
          description:
            "Life-saving procedure to filter blood in patients with kidney failure",
        },
        {
          name: "Peritoneal Dialysis",
          description:
            "Alternative home-based dialysis option for selected patients",
        },
        {
          name: "Kidney Biopsy",
        ...
        },
        {
          ...
          description:
            "Non-invasive imaging to detect structural abnormalities and blood flow",
        },
      ],
      treatments: [
        {
          ...
          description:
            "Medications and diet adjustments to control symptoms and slow disease",
        },
        {
          title: "Dialysis Services",
          description:
            "Comprehensive hemodialysis and peritoneal dialysis services with patient monitoring",
        },
        {
          title: "Anemia & Mineral Management",
          description:
            "Treatment of complications like low hemoglobin and bone health issues in kidney patients",
        },
        {
          title: "Transplant Evaluation & Referral",
          description:
            "Workup and coordination for patients eligible for kidney transplant",
        },
      ],
      symptoms: [
...

    {
      ...
      subtitle:
        "Your First Step Toward Accurate Diagnosis and Holistic Medical Care",
      heroDescription:
      ...
      treatmentExperienceTitle: "Our Treatment Experience",
      treatmentExperienceDesc:
        "We have managed thousands of patients with acute and chronic conditions, focusing on personalized care, accurate diagnosis, and preventive health strategies.",
      successRateTitle: "Comprehensive & Compassionate Care",
      successRateDesc:
        "Our patients benefit from early diagnosis, multi-system evaluation, and continuous monitoring, resulting in faster recovery and improved long-term outcomes.",
      conditionsTitle: "Conditions We Commonly Treat",
      conditionsDesc:
        "We handle a wide variety of acute and chronic medical conditions with a holistic and evidence-based approach.",
      proceduresTitle: "Diagnostic & Support Services",
      proceduresDesc:
        "Our department is equipped with essential diagnostic tools and offers full internal medicine support with referrals when necessary.",
      rehabTitle: "Lifestyle Counseling & Follow-Up Care",
      rehabDesc:
        "We guide patients with lifestyle changes, routine monitoring, and timely specialist referrals for better long-term health outcomes.",
      symptomsTitle: "Symptoms to Consult General Medicine For",
      symptomsDesc:
        "Consult our physicians early if you experience the following symptoms, which could indicate underlying health concerns.",
      sideEffectsTitle: "Possible Treatment Side Effects",
      sideEffectsDesc:
        "Most treatments are well-tolerated, though mild side effects can occur, and are monitored closely by our care team.",
      ...
      caseStats: [
        {
          ...
          description:
            "Effective management of common and complex internal health issues",
        },
        {
          count: "95%",
          title: "Diagnosis Accuracy",
          description:
            "Efficient evaluations with proper lab tests and imaging support",
        },
        {
          count: "12+",
        ...
        },
        {
          ...
          description:
            "Seamless referrals and multi-disciplinary collaboration when needed",
        },
      ],
      conditionsTreated: [
      ...
      procedures: [
        {
          ...
          description:
            "Lab tests to assess general health, organ function, and infection",
        },
        {
          name: "ECG & 2D Echo",
          description:
            "Heart evaluation for chest pain, palpitations, and hypertension",
        },
        {
          name: "X-Ray, Ultrasound, CT Scan",
          description:
            "Imaging for diagnosis of infections, organ issues, or structural concerns",
        },
        {
          name: "Blood Pressure & Glucose Monitoring",
          description:
            "Routine tracking for early detection of chronic diseases",
        },
        {
        ...
        },
        {
          ...
          description:
            "Screening and vaccination for lifestyle and infectious diseases",
        },
      ],
      treatments: [
        {
          ...
          description:
            "Effective treatment for infections, fever, and respiratory conditions",
        },
        {
          title: "Chronic Disease Monitoring",
          description:
            "Long-term management of diabetes, hypertension, and thyroid issues",
        },
        {
          title: "Nutritional & Lifestyle Counseling",
          description:
            "Support for weight loss, anemia, and general well-being",
        },
        {
          title: "Vaccination & Preventive Care",
          description:
            "Protection against diseases like flu, hepatitis, and typhoid",
        },
      ],
      symptoms: [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2 space-y-4">
                <div className="bg-white">
                  <div className="py-4 mx-auto px-4   rounded-xl shadow-lg border border-gray-200">
                    <div className="w-full">
                      ...
                      {/* <p className="text-xl text-gray-600 text-center md:text-justify">
                  {activeService?.subtitle}
                </p> */}
                ...
                <div className="bg-white rounded-xl p-4 shadow-md border border-gray-200">
                  ...
                  <h2 className="lg:text-3xl text-xl md:text-2x font-bold text-gray-900 mb-2">
