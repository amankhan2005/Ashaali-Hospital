  ...
  return (
    ...
    >
      <div className="container mx-auto">
        ...
        <div className="mb-3">
         <span
  className="text-sm md:text-base lg:text-lg font-semibold uppercase tracking-wider 
             block md:inline-block mx-auto md:mx-0 px-3 py-1 rounded-full border-2 text-center"
  style={{
    color: primaryColor,
...
>
  About Ashaali Hospital
        ...
        {/* Main heading */}
       <h1 className="text-lg md:text-3xl lg:text-4xl font-bold mb-3 leading-snug text-center md:text-left">
