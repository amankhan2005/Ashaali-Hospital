...
//   FaUsers, FaBuilding, FaStar, FaPhone, FaEnvelope, FaMapMarkerAlt, FaChevronDown, FaChevronUp
// } from "react-icons/fa";
...
//         {/* Header */}
//         <div className="text-center mb-10">
//           <div className="inline-flex items-center justify-center p-4 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full mb-4 shadow-lg">
//             <FaUserMd className="text-white text-3xl" />
//           </div>
//           <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal-700 to-cyan-700 mb-2">
//             Doctors Management
//           </h1>
...
//             <div className="flex items-center">
//               <div className="p-3 rounded-lg bg-teal-400/30 mr-4">
//                 <FaUsers className="text-2xl" />
//               </div>
//               <div>
//                 <p className="text-teal-100 text-sm">Total Doctors</p>
...
//             <div className="flex items-center">
//               <div className="p-3 rounded-lg bg-cyan-400/30 mr-4">
//                 <FaBuilding className="text-2xl" />
//               </div>
//               <div>
//                 <p className="text-cyan-100 text-sm">Departments</p>
...
//             <div className="flex items-center">
//               <div className="p-3 rounded-lg bg-blue-400/30 mr-4">
//                 <FaChartBar className="text-2xl" />
//               </div>
//               <div>
//                 <p className="text-blue-100 text-sm">Avg. per Dept</p>
//                 <p className="text-3xl font-bold">{totalDepartments ? Math.round(totalDoctors / totalDepartments) : 0}</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
//             >
//               {showDepartmentStats ? <FaChevronUp /> : <FaChevronDown />}
//             </button>
//           </div>
...
//                         style={{ width: `${(dept.count / totalDoctors) * 100}%` }}
//                       ></div>
//                     </div>
//                     <span className="text-sm font-medium text-gray-700 ml-2">{dept.count}</span>
//                   </div>
//                 </div>
//               ))}
//             </div>
...
//                   type="button"
//                   onClick={addSlot}
//                   className="px-4 py-2 text-sm font-medium rounded-lg text-white bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 transition flex items-center justify-center shadow-md"
//                 >
//                   <FaPlus className="mr-1" /> Add Slot
//                 </button>
//               </div>
...
//                 type="submit"
//                 disabled={isLoading}
//                 className="px-6 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-lg font-medium hover:from-teal-600 hover:to-cyan-600 transition flex items-center shadow-md"
//               >
//                 {isLoading ? (
//                   <>
//                     <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
//                   className="pl-10 pr-4 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition text-gray-800 placeholder-gray-400 w-full"
//                 />
//               </div>
...
//                   className="pl-10 pr-4 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition text-gray-800 w-full"
//                 >
...
//                 <div
//                   key={doctor._id}
//                   className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 flex flex-col h-full"
//                 >
...
//                       <button
//                         onClick={() => handleEdit(doctor)}
//                         className="flex-1 px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg font-medium hover:from-green-600 hover:to-green-700 transition flex items-center justify-center shadow-sm"
//                       >
//                         <FaEdit className="mr-1" /> Edit
//                       </button>
//                       <button
//                         onClick={() => handleDelete(doctor._id)}
//                         className="flex-1 px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg font-medium hover:from-red-600 hover:to-red-700 transition flex items-center justify-center shadow-sm"
//                       >
//                         <FaTrash className="mr-1" /> Delete
//                       </button>
//                     </div>
...
const DoctorsAdmin = () => {
  ...
  const fetchDepartments = async () => {
    try {
      ...
      setAllDepartments(res.data); // assuming API returns array of objects with { _id, name }
    } catch (err) {
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full pl-10 pr-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition text-gray-800"
                  >
