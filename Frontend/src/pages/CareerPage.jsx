...
const CareerPage = () => {
  ...
  // NEW: which job description is expanded
                    ...
                    return (
                      <div key={job._id} className="group bg-white border-2 border-gray-200 rounded-2xl p-6 hover:border-teal-300 hover:shadow-xl transition-all duration-300 flex flex-col h-full">
                        <div className="flex-grow">
                          ...
                          {job.description && (
                            <div>
                              <p className={`text-gray-600 text-sm leading-relaxed mb-2 ${isExpanded ? '' : 'line-clamp-3'}`}>
                                {job.description}
                              </p>
                              <button
                                ...
                                aria-controls={`job-desc-${job._id}`}
                              >
      ...
      <div className="py-10 md:py-8 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 bg-teal-100 text-teal-700 px-3 py-1 rounded-full mb-4 font-medium">
              <Award size={18} />
